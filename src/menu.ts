...
export class CETMenu extends Disposable {
    ...
    private mnemonics: Map<KeyCode, CETMenuItem[]>;
...
class Submenu extends CETMenuItem {
    ...
    private mysubmenu: CETMenu | null = null;
    ...
    constructor(item: MenuItem, private submenuItems: MenuItem[], private parentData: ISubMenuData,
                private submenuOptions?: IMenuOptions, closeSubMenu = () => {}) {
    ...
    render(container: HTMLElement): void {
        ...
        this._register(addDisposableListener(this.container, EventType.MOUSE_LEAVE, () => {
